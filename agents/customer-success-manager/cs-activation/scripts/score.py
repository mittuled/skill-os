#!/usr/bin/env python3
"""
score.py — Scores a cs activation output against the quality rubric
...
RUBRIC = {
    "Kickoff Quality": {"weight": 0.25, "description": "Structured meeting with confirmed goals, criteria, stakeholders, and timeline"},
    "Configuration Support": {"weight": 0.20, "description": "Completeness of product setup and blocker removal"},
    "First Use Case Delivery": {"weight": 0.25, "description": "End-to-end use case execution demonstrating product value"},
    "Value Verification": {"weight": 0.15, "description": "Customer confirmation of value milestone achievement"},
    "Transition Completeness": {"weight": 0.15, "description": "Smooth handoff to steady-state with documented next steps"},
}
