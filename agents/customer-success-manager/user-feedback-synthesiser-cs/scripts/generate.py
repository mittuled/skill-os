#!/usr/bin/env python3
"""
generate.py — Generates the output template for user-feedback-synthesiser-cs

Renders the output template for user-feedback-synthesiser-cs with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "feedback-synthesis-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "user-feedback-synthesiser-cs"))
    return result
