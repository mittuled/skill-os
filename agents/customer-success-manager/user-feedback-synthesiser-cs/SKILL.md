...
- [`nps-programme-manager`](../../customer-programs-manager/nps-programme-manager/SKILL.md) -- NPS verbatims are a key feedback source for synthesis.
- [`cs-health-monitor`](../../cs-manager/cs-health-monitor/SKILL.md) -- Feedback themes may explain health score trends.
