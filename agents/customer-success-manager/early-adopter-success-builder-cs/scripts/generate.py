#!/usr/bin/env python3
"""
generate.py — Generates the output template for early-adopter-success-builder-cs

Renders the output template for early-adopter-success-builder-cs with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "early-adopter-programme-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "early-adopter-success-builder-cs"))
    return result
