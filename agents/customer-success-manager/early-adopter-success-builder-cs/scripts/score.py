#!/usr/bin/env python3
"""
score.py — Scores a early adopter success builder cs output against the quality rubric
...
RUBRIC = {
    "Success Criteria Specificity": {"weight": 0.20, "description": "Early-adopter-specific criteria balancing product maturity with value delivery"},
    "Intervention Design": {"weight": 0.25, "description": "High-touch programme with weekly cadence, engineering access, and fast feedback loops"},
    "Execution Tracking": {"weight": 0.20, "description": "Per-customer progress monitoring with blocker resolution"},
    "Advocacy Cultivation": {"weight": 0.15, "description": "Natural progression from success to advocacy without premature requests"},
    "Product Feedback Quality": {"weight": 0.20, "description": "Structured insights report distinguishing GA-blockers from nice-to-haves"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "early-adopter-success-builder-cs",
