...
- [`developer-community-signal-extractor`](../../developer-relations-lead/developer-community-signal-extractor/SKILL.md) — Parallel skill for developer-specific community signal extraction.
