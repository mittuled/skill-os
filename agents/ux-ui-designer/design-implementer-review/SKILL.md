...
- [`design-review-runner`](../../head-of-design/design-review-runner/SKILL.md) -- Pre-implementation design reviews set the baseline that implementation reviews verify against.
