...
- [`accessibility-checker-design`](../../head-of-design/accessibility-checker-design/SKILL.md) -- Component mapping must verify that accessibility attributes (ARIA roles, focus behavior) are baked into system components.
