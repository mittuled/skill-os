#!/usr/bin/env python3
"""
run.py — Orchestrates the full team-capability-assessor workflow.

Runs the complete team capability assessor workflow: score input document and generate output template.
