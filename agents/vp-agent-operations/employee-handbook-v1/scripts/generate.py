#!/usr/bin/env python3
"""
generate.py — Generates the output template for employee-handbook-v1

Renders the output template for employee-handbook-v1 with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "agent-governance-manual-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "employee-handbook-v1"))
    return result
