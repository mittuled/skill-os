...
- [`skills-gap-analyser`](../../agent-trainer-skill-optimizer/skills-gap-analyser/SKILL.md) -- Analyzes specific skill deficiencies found during performance reviews.
- [`team-health-monitor`](../../agent-operations-manager/team-health-monitor/SKILL.md) -- Provides the real-time health data that feeds into periodic performance reviews.
