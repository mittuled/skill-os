#!/usr/bin/env python3
"""
generate.py — Generates the output template for culture-and-performance-system

Renders the output template for culture-and-performance-system with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "fleet-performance-review-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "culture-and-performance-system"))
    return result
