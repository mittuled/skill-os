#!/usr/bin/env python3
"""
run.py — Orchestrates the full culture-and-performance-system workflow.

Runs the complete culture and performance system workflow: score input document and generate output template.
