#!/usr/bin/env python3
"""
score.py — Scores a fleet scale plan against the quality rubric
...
RUBRIC = {
    "Demand Assessment": {"weight": 0.20, "description": "Completeness of capability-to-requirement mapping with gap identification"},
    "Current State Audit": {"weight": 0.15, "description": "Accuracy of existing topology with utilization data"},
    "Topology Design": {"weight": 0.25, "description": "Clarity of target roles, boundaries, and coordination patterns"},
    "Provisioning Feasibility": {"weight": 0.20, "description": "Realism of sequencing, resources, and timeline"},
    "Migration Risk Management": {"weight": 0.20, "description": "Runbook quality including rollback triggers"},
}
