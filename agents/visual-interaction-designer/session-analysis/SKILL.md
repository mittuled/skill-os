...
- [`iteration-prioritiser-design`](../../head-of-design/iteration-prioritiser-design/SKILL.md) -- Analysis severity rankings inform backlog prioritization.
- [`accessibility-auditor-design`](../../head-of-design/accessibility-auditor-design/SKILL.md) -- Session recordings may reveal accessibility barriers that warrant a formal audit.
