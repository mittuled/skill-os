...
- [`iteration-prioritiser-design`](../../head-of-design/iteration-prioritiser-design/SKILL.md) -- The iteration backlog determines which improvements are prioritized for design.
- [`design-implementer-review`](../../ux-ui-designer/design-implementer-review/SKILL.md) -- Implementation review verifies that the iteration was built to spec.
