#!/usr/bin/env python3
"""
run.py — Orchestrates the full tam-playbook-contributor workflow.

Runs the complete tam playbook contributor workflow: score input document and generate output template.
