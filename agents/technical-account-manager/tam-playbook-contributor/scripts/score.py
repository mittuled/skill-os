#!/usr/bin/env python3
"""
score.py — Scores a tam playbook contributor output against the quality rubric
...
RUBRIC = {
    "Gap Identification": {"weight": 0.25, "description": "Systematic identification of undocumented procedures and inconsistencies"},
    "Documentation Quality": {"weight": 0.30, "description": "Practical, reality-based procedures rather than theoretical"},
    "Peer Validation": {"weight": 0.25, "description": "Review by other TAMs with practical feedback incorporated"},
    "Integration Quality": {"weight": 0.20, "description": "Accessibility in playbook and reference in TAM onboarding"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "tam-playbook-contributor",
