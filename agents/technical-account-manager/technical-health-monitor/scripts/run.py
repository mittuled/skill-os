#!/usr/bin/env python3
"""
run.py — Orchestrates the full technical-health-monitor workflow.

Runs the complete technical health monitor workflow: score input document and generate output template.
