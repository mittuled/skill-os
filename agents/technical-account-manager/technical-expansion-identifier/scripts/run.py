#!/usr/bin/env python3
"""
run.py — Orchestrates the full technical-expansion-identifier workflow.

Runs the complete technical expansion identifier workflow: score input document and generate output template.
