...
- [`vendor-contract-manager`](../../vendor-management-procurement/vendor-contract-manager/SKILL.md) -- vendor contract management handles the commercial terms of SaaS subscriptions.
