...
- [`it-helpdesk-operator`](../../it-support-specialist/it-helpdesk-operator/SKILL.md) -- helpdesk resolves day-to-day hardware issues that lifecycle management plans for.
