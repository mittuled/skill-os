...
- [`objection-handler-updater-sales`](../../../sales/sales-manager/objection-handler-updater-sales/SKILL.md) -- Consumes pricing objection patterns surfaced during validation.
