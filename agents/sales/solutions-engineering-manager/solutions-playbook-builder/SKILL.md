...
- [`sales-playbook-builder`](../../../sales/sales-manager/sales-playbook-builder/SKILL.md) -- The sales counterpart playbook that aligns with the SE playbook on qualification and process.
- [`proof-of-concept-runner`](../../../sales/solutions-engineer/proof-of-concept-runner/SKILL.md) -- Executes POCs using the criteria and frameworks defined in this playbook.
