...
- [`sales-signal-collector`](../../../sales/account-executive/sales-signal-collector/SKILL.md) — Provides engagement signals that determine the correct follow-up scenario and inform personalization.
