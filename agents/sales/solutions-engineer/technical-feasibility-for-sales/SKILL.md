...
- [`technical-buyer-signal-extractor`](../../../sales/solutions-engineering-manager/technical-buyer-signal-extractor/SKILL.md) -- Consumes feasibility gaps as technical buyer signals for Product.
