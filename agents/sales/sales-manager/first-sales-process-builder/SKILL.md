...
- [`opportunity-framer-sales`](../../../sales/vp-sales/opportunity-framer-sales/SKILL.md) -- Provides the opportunity frame and motion blueprint this process operationalizes.
