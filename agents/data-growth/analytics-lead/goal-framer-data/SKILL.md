...
- [`goal-framer`](../../../product/vp-product/goal-framer/SKILL.md) -- the product goal framer sets the business objectives that this skill translates into analytics goals.
