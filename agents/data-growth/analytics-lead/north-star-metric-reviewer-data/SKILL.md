...
- [`north-star-metric-reviewer`](../../../product/vp-product/north-star-metric-reviewer/SKILL.md) -- the VP Product reviews the north star from a strategic perspective; this skill provides the data analysis.
