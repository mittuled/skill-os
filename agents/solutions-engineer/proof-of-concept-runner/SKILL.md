...
- [`solutions-playbook-builder`](../../solutions-engineering-manager/solutions-playbook-builder/SKILL.md) -- Provides the POC criteria and frameworks this skill executes against.
