...
- [`business-model-legal-reviewer`](../../product-counsel/business-model-legal-reviewer/SKILL.md) -- Provides deeper business model legal analysis once the idea progresses past initial screening.
- [`compliance-scanner`](../../corporate-counsel/compliance-scanner/SKILL.md) -- Performs comprehensive regulatory compliance scanning when the idea enters a regulated domain.
