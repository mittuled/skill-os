...
related-skills:
  ...
  - ../../fpa-analyst/annual-budget-builder/SKILL.md
---
...
- [`fundraising-model-builder`](../../fpa-analyst/fundraising-model-builder/SKILL.md) -- Extends this v1 model into an investor-facing format with use-of-proceeds and dilution analysis.
- [`annual-budget-builder`](../../fpa-analyst/annual-budget-builder/SKILL.md) -- Uses this model as the foundation for departmental budget allocation.
