...
complexity: medium
related-skills:
  - ../../fpa-analyst/fundraising-model-builder/SKILL.md
  - ../../investor-relations-manager/fundraising-process-manager/SKILL.md
---
...
- [`fundraising-model-builder`](../../fpa-analyst/fundraising-model-builder/SKILL.md) -- Builds the investor-facing financial model that this narrative draws from.
- [`fundraising-process-manager`](../../investor-relations-manager/fundraising-process-manager/SKILL.md) -- Manages the overall fundraising process that this pitch narrative supports.
