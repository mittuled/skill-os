#!/usr/bin/env python3
"""
generate.py — Generates the output template for first-hire-process-builder

Renders the output template for first-hire-process-builder with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "deployment-procedure-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "first-hire-process-builder"))
    return result
