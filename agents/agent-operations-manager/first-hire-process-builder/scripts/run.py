#!/usr/bin/env python3
"""
run.py — Orchestrates the full first-hire-process-builder workflow.

Runs the complete first hire process builder workflow: score input document and generate output template.
