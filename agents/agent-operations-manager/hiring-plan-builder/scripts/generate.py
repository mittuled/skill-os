#!/usr/bin/env python3
"""
generate.py — Generates the output template for hiring-plan-builder

Renders the output template for hiring-plan-builder with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "provisioning-plan-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "hiring-plan-builder"))
    return result
