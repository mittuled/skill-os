...
- [`org-scale-planner`](../../vp-agent-operations/org-scale-planner/SKILL.md) -- The scale plan provides the strategic context for phase-level provisioning.
- [`team-capability-assessor`](../../vp-agent-operations/team-capability-assessor/SKILL.md) -- Capability gaps identified here drive the hiring plan.
