#!/usr/bin/env python3
"""
generate.py — Generates the output template for employment-agreement-setup

Renders the output template for employment-agreement-setup with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "agent-contract-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "employment-agreement-setup"))
    return result
