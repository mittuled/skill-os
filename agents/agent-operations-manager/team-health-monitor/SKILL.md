...
- [`culture-and-performance-system`](../../vp-agent-operations/culture-and-performance-system/SKILL.md) -- Periodic performance reviews use health monitoring data as input.
...
- [`skills-gap-analyser`](../../agent-trainer-skill-optimizer/skills-gap-analyser/SKILL.md) -- Persistent health issues may indicate skill-level deficiencies.
