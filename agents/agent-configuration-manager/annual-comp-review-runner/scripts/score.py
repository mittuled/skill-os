#!/usr/bin/env python3
"""
score.py — Scores a annual comp review runner output against the quality rubric
...
RUBRIC = {
    "Configuration Completeness": {"weight": 0.20, "description": "Coverage of model, compute, context window, tool access, and API scope per agent"},
    "Data-Driven Analysis": {"weight": 0.25, "description": "Use of actual performance and cost data vs assumptions"},
    "Right-Sizing Accuracy": {"weight": 0.25, "description": "Identification of over/under-provisioned agents with evidence"},
    "Change Proposal Quality": {"weight": 0.15, "description": "Specificity of proposals with cost impact estimates"},
    "Post-Change Validation": {"weight": 0.15, "description": "Verification that changes did not regress performance"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "annual-comp-review-runner",
