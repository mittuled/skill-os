#!/usr/bin/env python3
"""
score.py — Scores a benefits setup v1 output against the quality rubric
...
RUBRIC = {
    "Tool Catalog Completeness": {"weight": 0.30, "description": "Coverage of all available tools with categorization"},
    "Baseline Selection Quality": {"weight": 0.30, "description": "Appropriateness of universal vs role-specific tool assignments"},
    "Provisioning Validation": {"weight": 0.20, "description": "Successful connection testing for all configured tools"},
    "Documentation Quality": {"weight": 0.20, "description": "Baseline package documentation for future agent onboarding"},
}
