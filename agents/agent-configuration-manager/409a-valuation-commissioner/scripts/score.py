#!/usr/bin/env python3
"""
score.py — Scores a 409a valuation commissioner output against the quality rubric
...
RUBRIC = {
    "Cost Data Accuracy": {"weight": 0.25, "description": "Per-agent compute cost breakdown including model, context, tools, and infrastructure"},
    "Value Quantification": {"weight": 0.25, "description": "Business value estimation using both direct outputs and indirect value"},
    "ROI Calculation Rigour": {"weight": 0.25, "description": "Cost-to-value ratio methodology with appropriate proxy metrics"},
    "Recommendation Quality": {"weight": 0.25, "description": "Specificity of cost adjustment recommendations with impact estimates"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "409a-valuation-commissioner",
