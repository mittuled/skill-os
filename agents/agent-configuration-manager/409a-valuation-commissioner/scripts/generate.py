#!/usr/bin/env python3
"""
generate.py — Generates the output template for 409a-valuation-commissioner

Renders the output template for 409a-valuation-commissioner with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "roi-assessment-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "409a-valuation-commissioner"))
    return result
