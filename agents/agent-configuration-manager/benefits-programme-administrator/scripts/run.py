#!/usr/bin/env python3
"""
run.py — Orchestrates the full benefits-programme-administrator workflow.

Runs the complete benefits programme administrator workflow: score input document and generate output template.
