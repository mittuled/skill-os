#!/usr/bin/env python3
"""
generate.py — Generates the output template for benefits-programme-administrator

Renders the output template for benefits-programme-administrator with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "tool-access-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "benefits-programme-administrator"))
    return result
