#!/usr/bin/env python3
"""
score.py — Scores a equity programme manager output against the quality rubric
...
RUBRIC = {
    "Resource Inventory Accuracy": {"weight": 0.20, "description": "Completeness of premium capability catalog with budget constraints"},
    "Needs Assessment Rigour": {"weight": 0.25, "description": "Data-driven evaluation of per-role premium requirements"},
    "Allocation Fairness": {"weight": 0.25, "description": "Business-impact-based distribution avoiding political allocation"},
    "Utilization Monitoring": {"weight": 0.15, "description": "Tracking of actual vs allocated premium usage"},
    "Rebalancing Discipline": {"weight": 0.15, "description": "Evidence of periodic adjustment based on utilization data"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "equity-programme-manager",
