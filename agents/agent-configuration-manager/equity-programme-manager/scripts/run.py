#!/usr/bin/env python3
"""
run.py — Orchestrates the full equity-programme-manager workflow.

Runs the complete equity programme manager workflow: score input document and generate output template.
