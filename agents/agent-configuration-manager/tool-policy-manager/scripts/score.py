#!/usr/bin/env python3
"""
score.py — Scores a tool policy manager output against the quality rubric
...
RUBRIC = {
    "Policy Parse Accuracy": {"weight": 0.20, "description": "Correct loading of all policy levels from allowed-tools.yaml"},
    "Request Validation": {"weight": 0.25, "description": "Completeness of change request validation with conflict detection"},
    "Change Application Quality": {"weight": 0.25, "description": "Correct modification preserving YAML structure and comments"},
    "Schema Validation": {"weight": 0.15, "description": "Passing validation script post-change"},
    "Reporting Quality": {"weight": 0.15, "description": "Clear change summary with before/after diff"},
}
