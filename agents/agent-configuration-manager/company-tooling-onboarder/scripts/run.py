#!/usr/bin/env python3
"""
run.py — Orchestrates the full company-tooling-onboarder workflow.

Runs the complete company tooling onboarder workflow: score input document and generate output template.
