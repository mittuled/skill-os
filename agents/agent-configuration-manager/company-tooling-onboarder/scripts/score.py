#!/usr/bin/env python3
"""
score.py — Scores a company tooling onboarder output against the quality rubric
...
RUBRIC = {
    "Discovery Completeness": {"weight": 0.20, "description": "Coverage of all organizational tool categories in the manifest"},
    "MCP Availability Assessment": {"weight": 0.15, "description": "Accuracy of MCP/CLI/API classification per tool"},
    "Authentication Security": {"weight": 0.25, "description": "Credential storage in secret store, never in repo"},
    "Connection Validation": {"weight": 0.20, "description": "End-to-end connectivity testing for every tool"},
    "Policy Generation Quality": {"weight": 0.20, "description": "Completeness and accuracy of generated allowed-tools.yaml"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "company-tooling-onboarder",
