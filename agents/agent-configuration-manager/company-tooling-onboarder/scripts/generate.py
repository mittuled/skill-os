#!/usr/bin/env python3
"""
generate.py — Generates the output template for company-tooling-onboarder

Renders the output template for company-tooling-onboarder with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "tooling-onboarding-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "company-tooling-onboarder"))
    return result
