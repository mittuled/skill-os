...
- [`team-allocator`](../../vp-engineering/team-allocator/SKILL.md) -- uses effort estimates to determine staffing assignments.
- [`phase-planner-eng`](../../vp-engineering/phase-planner-eng/SKILL.md) -- effort estimates feed directly into phase planning timelines.
