...
- [`spec-translator-eng`](../../tech-lead-pr-reviewer/spec-translator-eng/SKILL.md) -- translates specs into engineering tasks at the tech lead level; backlog population builds on this output.
- [`backlog-groomer-eng`](../../tech-lead-pr-reviewer/backlog-groomer-eng/SKILL.md) -- grooms the backlog after it has been populated to keep tasks sprint-ready.
