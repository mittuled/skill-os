...
- [`effort-estimator-eng`](../../vp-engineering/effort-estimator-eng/SKILL.md) -- effort estimates determine how many engineers are needed.
- [`phase-planner-eng`](../../vp-engineering/phase-planner-eng/SKILL.md) -- phase plans define the timeline that allocations must fit.
