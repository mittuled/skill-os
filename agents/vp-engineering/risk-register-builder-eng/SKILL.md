...
- [`go-live-approver-lead`](../../vp-engineering/go-live-approver-lead/SKILL.md) -- the risk register is a key input to go-live approval decisions.
- [`scope-boundary-setter-eng`](../../vp-engineering/scope-boundary-setter-eng/SKILL.md) -- scope boundary changes often introduce new risks to track.
