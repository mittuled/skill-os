...
- [`financial-model-v1`](../../../finance/cfo-vp-finance/financial-model-v1/SKILL.md) -- Provides the base operating model that this fundraising model extends.
- [`pitch-narrator-finance`](../../../finance/cfo-vp-finance/pitch-narrator-finance/SKILL.md) -- Crafts the narrative that accompanies this model in investor presentations.
