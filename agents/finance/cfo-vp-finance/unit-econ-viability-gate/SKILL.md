...
- [`unit-economics-monitor`](../../../finance/fpa-analyst/unit-economics-monitor/SKILL.md) -- Provides ongoing tracking of the metrics validated at this gate; triggers re-evaluation when thresholds breach.
- [`business-model-sketcher-finance`](../../../finance/finance-manager/business-model-sketcher-finance/SKILL.md) -- Produces the business model that this gate validates for unit economics viability.
