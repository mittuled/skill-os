...
- [`pricing-review-runner`](../../../finance/fpa-analyst/pricing-review-runner/SKILL.md) -- Conducts periodic pricing reviews that feed into this final sign-off decision.
