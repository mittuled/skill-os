...
- [`monthly-variance-analyser`](../../../finance/fpa-analyst/monthly-variance-analyser/SKILL.md) -- Provides the broader variance context that revenue impact monitoring feeds into.
