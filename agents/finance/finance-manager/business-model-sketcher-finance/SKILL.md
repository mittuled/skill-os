...
- [`unit-econ-viability-gate`](../../../finance/cfo-vp-finance/unit-econ-viability-gate/SKILL.md) -- Provides the CFO-level gate decision that follows this financial review.
