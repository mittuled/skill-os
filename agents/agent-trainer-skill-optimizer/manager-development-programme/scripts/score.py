#!/usr/bin/env python3
"""
score.py — Scores a manager development programme output against the quality rubric
...
RUBRIC = {
    "Baseline Assessment Quality": {"weight": 0.25, "description": "Accuracy of delegation, context preservation, and coordination metrics"},
    "Training Gap Analysis": {"weight": 0.20, "description": "Specificity of identified training needs from error analysis"},
    "Programme Design": {"weight": 0.25, "description": "Coverage of delegation, context packaging, and coordination scenarios"},
    "Training Effectiveness": {"weight": 0.15, "description": "Before/after comparison with measurable improvement"},
    "Deployment Validation": {"weight": 0.15, "description": "Production readiness confirmation with threshold compliance"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "manager-development-programme",
