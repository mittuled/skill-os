#!/usr/bin/env python3
"""
generate.py — Generates the output template for manager-development-programme

Renders the output template for manager-development-programme with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "orchestrator-training-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "manager-development-programme"))
    return result
