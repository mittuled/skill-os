#!/usr/bin/env python3
"""
score.py — Scores a compliance training manager output against the quality rubric
...
RUBRIC = {
    "Requirements Coverage": {"weight": 0.25, "description": "Completeness of security, privacy, and regulatory constraint inventory"},
    "Test Design Quality": {"weight": 0.25, "description": "Boundary condition coverage, adversarial scenarios, and prohibited behavior probing"},
    "Evaluation Thoroughness": {"weight": 0.20, "description": "Per-agent test execution with evidence collection"},
    "Remediation Specificity": {"weight": 0.15, "description": "Root cause identification and prescriptive fix plans"},
    "Certification Rigour": {"weight": 0.15, "description": "Formal certification issuance with risk register updates"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "compliance-training-manager",
