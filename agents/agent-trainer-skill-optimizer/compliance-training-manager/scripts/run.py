#!/usr/bin/env python3
"""
run.py — Orchestrates the full compliance-training-manager workflow.

Runs the complete compliance training manager workflow: score input document and generate output template.
