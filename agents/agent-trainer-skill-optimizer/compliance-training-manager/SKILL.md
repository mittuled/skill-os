...
- [`employee-handbook-v1`](../../vp-agent-operations/employee-handbook-v1/SKILL.md) -- Governance policies that define the compliance baseline.
- [`culture-and-performance-system`](../../vp-agent-operations/culture-and-performance-system/SKILL.md) -- Performance reviews incorporate compliance status.
- [`team-health-monitor`](../../agent-operations-manager/team-health-monitor/SKILL.md) -- Runtime compliance violations may surface as health anomalies.
