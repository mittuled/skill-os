#!/usr/bin/env python3
"""
run.py — Orchestrates the full skills-gap-analyser workflow.

Runs the complete skills gap analyser workflow: score input document and generate output template.
