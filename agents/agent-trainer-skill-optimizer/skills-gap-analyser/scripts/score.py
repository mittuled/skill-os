#!/usr/bin/env python3
"""
score.py — Scores a skills gap analyser output against the quality rubric
...
RUBRIC = {
    "Data Collection Quality": {"weight": 0.20, "description": "Breadth and recency of performance data across all skills"},
    "Benchmark Accuracy": {"weight": 0.20, "description": "Appropriateness of per-skill thresholds avoiding inflation"},
    "Gap Classification": {"weight": 0.25, "description": "Correctness of prompt/training/model/tool categorization"},
    "Prioritization Rigour": {"weight": 0.20, "description": "Business impact and fix difficulty ranking with justification"},
    "Recommendation Quality": {"weight": 0.15, "description": "Specificity of actions: update/rewrite/upgrade/retire"},
}
