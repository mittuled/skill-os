#!/usr/bin/env python3
"""
score.py — Scores a onboarding programme builder output against the quality rubric
...
RUBRIC = {
    "Success Criteria Clarity": {"weight": 0.25, "description": "Specificity of production-ready thresholds per role"},
    "Warm-Up Scenario Coverage": {"weight": 0.25, "description": "Range from routine to edge cases including known failure modes"},
    "Tuning Effectiveness": {"weight": 0.20, "description": "Iterative improvement with per-scenario scoring"},
    "Certification Completeness": {"weight": 0.15, "description": "Production readiness certificate with capability documentation"},
    "Handoff Quality": {"weight": 0.15, "description": "Completeness of information transfer to Agent Ops Manager"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "onboarding-programme-builder",
