...
- [`first-hire-process-builder`](../../../agent-operations/agent-operations-manager/first-hire-process-builder/SKILL.md) -- Deployment procedure that precedes onboarding.
