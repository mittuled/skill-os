#!/usr/bin/env python3
"""
run.py — Orchestrates the full onboarding-programme-builder workflow.

Runs the complete onboarding programme builder workflow: score input document and generate output template.
