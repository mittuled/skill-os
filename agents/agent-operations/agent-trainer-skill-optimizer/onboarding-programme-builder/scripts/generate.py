#!/usr/bin/env python3
"""
generate.py — Generates the output template for onboarding-programme-builder

Renders the output template for onboarding-programme-builder with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "onboarding-programme-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "onboarding-programme-builder"))
    return result
