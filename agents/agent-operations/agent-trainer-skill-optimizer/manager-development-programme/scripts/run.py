#!/usr/bin/env python3
"""
run.py — Orchestrates the full manager-development-programme workflow.

Runs the complete manager development programme workflow: score input document and generate output template.
