#!/usr/bin/env python3
"""
generate.py — Generates the output template for technical-skills-programme

Renders the output template for technical-skills-programme with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "model-transition-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "technical-skills-programme"))
    return result
