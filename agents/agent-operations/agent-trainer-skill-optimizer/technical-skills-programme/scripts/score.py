#!/usr/bin/env python3
"""
score.py — Scores a technical skills programme output against the quality rubric
...
RUBRIC = {
    "Impact Assessment Accuracy": {"weight": 0.25, "description": "Completeness of affected skill identification with behavior dependency mapping"},
    "Regression Test Coverage": {"weight": 0.25, "description": "Breadth of regression testing with baseline comparison"},
    "Update Programme Design": {"weight": 0.20, "description": "Appropriateness of fix type (prompt/restructure/rewrite) per skill"},
    "Execution Quality": {"weight": 0.15, "description": "Post-fix evaluation confirming resolution without new regressions"},
    "Deployment Safety": {"weight": 0.15, "description": "Staged rollout with monitoring and rollback readiness"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "technical-skills-programme",
