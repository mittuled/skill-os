#!/usr/bin/env python3
"""
run.py — Orchestrates the full technical-skills-programme workflow.

Runs the complete technical skills programme workflow: score input document and generate output template.
