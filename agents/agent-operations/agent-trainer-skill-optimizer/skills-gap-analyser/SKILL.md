...
- [`culture-and-performance-system`](../../../agent-operations/vp-agent-operations/culture-and-performance-system/SKILL.md) -- Fleet performance reviews that surface skill-level issues.
- [`recruiting-pipeline-builder`](../../../agent-operations/skill-builder-lead/recruiting-pipeline-builder/SKILL.md) -- Skill gaps feed into the pipeline for new skill development.
