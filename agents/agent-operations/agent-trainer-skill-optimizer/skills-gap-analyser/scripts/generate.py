#!/usr/bin/env python3
"""
generate.py — Generates the output template for skills-gap-analyser

Renders the output template for skills-gap-analyser with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "skills-gap-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "skills-gap-analyser"))
    return result
