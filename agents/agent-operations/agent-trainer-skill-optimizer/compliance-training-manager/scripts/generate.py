#!/usr/bin/env python3
"""
generate.py — Generates the output template for compliance-training-manager

Renders the output template for compliance-training-manager with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "compliance-evaluation-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "compliance-training-manager"))
    return result
