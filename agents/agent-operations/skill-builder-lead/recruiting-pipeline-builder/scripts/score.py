#!/usr/bin/env python3
"""
score.py — Scores a skill development pipeline against the quality rubric
...
RUBRIC = {
    "Gap Intake Quality": {"weight": 0.20, "description": "Completeness of gap collection from all sources with deduplication"},
    "Specification Rigour": {"weight": 0.25, "description": "Clarity of per-skill specs with acceptance criteria and complexity estimates"},
    "Pipeline Sequencing": {"weight": 0.25, "description": "Dependency-aware ordering aligned with delivery deadlines"},
    "Progress Tracking": {"weight": 0.15, "description": "Monitoring of builder progress with blocker identification"},
    "Quality Gate Effectiveness": {"weight": 0.15, "description": "Review rigour against specifications before registry entry"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "recruiting-pipeline-builder",
