#!/usr/bin/env python3
"""
generate.py — Generates the output template for recruiting-pipeline-builder

Renders the output template for recruiting-pipeline-builder with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "skill-development-pipeline-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "recruiting-pipeline-builder"))
    return result
