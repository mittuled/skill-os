...
- [`team-capability-assessor`](../../../agent-operations/vp-agent-operations/team-capability-assessor/SKILL.md) -- Provides the capability gaps that feed the pipeline.
...
- [`engineering-talent-sourcer`](../../../agent-operations/skill-builder/engineering-talent-sourcer/SKILL.md) -- Individual Skill Builders execute assignments from this pipeline.
