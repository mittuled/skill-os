#!/usr/bin/env python3
"""
run.py — Orchestrates the full 409a-valuation-commissioner workflow.

Runs the complete 409a valuation commissioner workflow: score input document and generate output template.
