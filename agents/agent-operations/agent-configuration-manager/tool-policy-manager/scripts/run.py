#!/usr/bin/env python3
"""
run.py — Orchestrates the full tool-policy-manager workflow.

Runs the complete tool policy manager workflow: score input document and generate output template.
