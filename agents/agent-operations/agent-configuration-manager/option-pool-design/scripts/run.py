#!/usr/bin/env python3
"""
run.py — Orchestrates the full option-pool-design workflow.

Runs the complete option pool design workflow: score input document and generate output template.
