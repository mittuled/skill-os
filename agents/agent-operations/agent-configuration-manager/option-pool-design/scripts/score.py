#!/usr/bin/env python3
"""
score.py — Scores a option pool design output against the quality rubric
...
RUBRIC = {
    "Budget Breakdown Quality": {"weight": 0.25, "description": "Completeness of cost category breakdown"},
    "Tier Classification Accuracy": {"weight": 0.25, "description": "Appropriateness of high/medium/low agent grouping"},
    "Allocation Model Design": {"weight": 0.25, "description": "Budget distribution with scaling rules and growth headroom"},
    "Per-Agent Budget Specificity": {"weight": 0.25, "description": "Concrete assignments: model tier, max tokens, requests/day, context limits"},
}
