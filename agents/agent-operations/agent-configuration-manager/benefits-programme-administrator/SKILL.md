...
- [`employment-agreement-setup`](../../../agent-operations/agent-operations-manager/employment-agreement-setup/SKILL.md) -- Agent contracts specify tool access requirements.
