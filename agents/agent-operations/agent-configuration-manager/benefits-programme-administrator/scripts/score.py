#!/usr/bin/env python3
"""
score.py — Scores a benefits programme administrator output against the quality rubric
...
RUBRIC = {
    "Requirements Assessment": {"weight": 0.25, "description": "Thoroughness of per-agent tool needs analysis with justification"},
    "Provisioning Security": {"weight": 0.25, "description": "Least-privilege application with unique per-agent credentials"},
    "Integration Validation": {"weight": 0.20, "description": "End-to-end testing of each tool connection"},
    "Documentation Completeness": {"weight": 0.15, "description": "Configuration registry with expiration and renewal info"},
    "Maintenance Discipline": {"weight": 0.15, "description": "Periodic review cadence with stale access revocation"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "benefits-programme-administrator",
