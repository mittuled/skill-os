#!/usr/bin/env python3
"""
score.py — Scores a compensation benchmarking output against the quality rubric
...
RUBRIC = {
    "Benchmark Suite Design": {"weight": 0.25, "description": "Role-specificity of test tasks vs generic benchmarks"},
    "Benchmark Execution Quality": {"weight": 0.25, "description": "Coverage of candidate models with consistent methodology"},
    "Cost-Performance Analysis": {"weight": 0.25, "description": "Efficient frontier identification with trade-off documentation"},
    "Selection Justification": {"weight": 0.25, "description": "Documented rationale for each model-to-role assignment"},
}
