#!/usr/bin/env python3
"""
run.py — Orchestrates the full compensation-benchmarking workflow.

Runs the complete compensation benchmarking workflow: score input document and generate output template.
