#!/usr/bin/env python3
"""
generate.py — Generates the output template for compensation-benchmarking

Renders the output template for compensation-benchmarking with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "model-benchmark-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "compensation-benchmarking"))
    return result
