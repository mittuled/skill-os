#!/usr/bin/env python3
"""
generate.py — Generates the output template for annual-comp-review-runner

Renders the output template for annual-comp-review-runner with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "annual-config-review-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "annual-comp-review-runner"))
    return result
