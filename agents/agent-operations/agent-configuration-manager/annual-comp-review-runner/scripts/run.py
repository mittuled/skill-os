#!/usr/bin/env python3
"""
run.py — Orchestrates the full annual-comp-review-runner workflow.

Runs the complete annual comp review runner workflow: score input document and generate output template.
