#!/usr/bin/env python3
"""
score.py — Scores a first-agent deployment procedure against the quality rubric
...
RUBRIC = {
    "Success Criteria Clarity": {"weight": 0.25, "description": "Specificity of accuracy, latency, and error rate targets"},
    "Testing Pipeline Rigour": {"weight": 0.25, "description": "Coverage of unit, integration, and end-to-end tests"},
    "Validation Completeness": {"weight": 0.20, "description": "Pre-deployment gates for compliance, contracts, and security"},
    "Runbook Quality": {"weight": 0.15, "description": "Step-by-step deployment with rollback procedures"},
    "Documentation": {"weight": 0.15, "description": "Post-deployment log with lessons learned"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "first-hire-process-builder",
