...
- [`onboarding-programme-builder`](../../../agent-operations/agent-trainer-skill-optimizer/onboarding-programme-builder/SKILL.md) -- Post-deployment warm-up follows the deployment procedure.
- [`employee-handbook-v1`](../../../agent-operations/vp-agent-operations/employee-handbook-v1/SKILL.md) -- Governance policies that the deployment procedure must enforce.
