#!/usr/bin/env python3
"""
score.py — Scores a phased provisioning plan against the quality rubric
...
RUBRIC = {
    "Phase Mapping Accuracy": {"weight": 0.25, "description": "Completeness of capability-to-phase mapping with workload estimates"},
    "Fleet Coverage Assessment": {"weight": 0.20, "description": "Accuracy of existing fleet match against requirements"},
    "Schedule Feasibility": {"weight": 0.25, "description": "Realism of provisioning timeline including lead times"},
    "Resource Allocation": {"weight": 0.15, "description": "Specificity of compute, model, and tool requirements per agent"},
    "Stakeholder Communication": {"weight": 0.15, "description": "Clarity of plan communication and priority alignment"},
}
