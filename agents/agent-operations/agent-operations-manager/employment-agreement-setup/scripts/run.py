#!/usr/bin/env python3
"""
run.py — Orchestrates the full employment-agreement-setup workflow.

Runs the complete employment agreement setup workflow: score input document and generate output template.
