#!/usr/bin/env python3
"""
run.py — Orchestrates the full tool-health-checker workflow.

Runs the complete tool health checker workflow: score input document and generate output template.
