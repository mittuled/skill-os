#!/usr/bin/env python3
"""
score.py — Scores a tool health report against the quality rubric
...
RUBRIC = {
    "Policy Coverage": {"weight": 0.25, "description": "Percentage of registered tools probed across all policy levels"},
    "Probe Accuracy": {"weight": 0.25, "description": "Correctness of health status classification (healthy/degraded/unreachable)"},
    "Report Completeness": {"weight": 0.25, "description": "Presence of tool name, status, latency, timestamp, and remediation per tool"},
    "Critical Alert Quality": {"weight": 0.25, "description": "Specificity and actionability of alerts for unreachable tools"},
}
