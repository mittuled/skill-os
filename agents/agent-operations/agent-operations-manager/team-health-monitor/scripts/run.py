#!/usr/bin/env python3
"""
run.py — Orchestrates the full team-health-monitor workflow.

Runs the complete team health monitor workflow: score input document and generate output template.
