#!/usr/bin/env python3
"""
score.py — Scores a fleet health report against the monitoring quality rubric
...
RUBRIC = {
    "Metric Definition Quality": {"weight": 0.25, "description": "Completeness of per-role metrics with thresholds for healthy/warning/critical"},
    "Instrumentation Coverage": {"weight": 0.20, "description": "Data collection setup across all agents with sufficient granularity"},
    "Anomaly Detection": {"weight": 0.25, "description": "Effectiveness of threshold-based and trend-based anomaly identification"},
    "Diagnosis Depth": {"weight": 0.15, "description": "Root cause analysis quality for detected anomalies"},
    "Escalation Effectiveness": {"weight": 0.15, "description": "Timeliness and appropriateness of escalation with actionable context"},
}
