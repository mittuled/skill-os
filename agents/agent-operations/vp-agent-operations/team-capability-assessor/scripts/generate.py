#!/usr/bin/env python3
"""
generate.py — Generates the output template for team-capability-assessor

Renders the output template for team-capability-assessor with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "capability-assessment-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "team-capability-assessor"))
    return result
