#!/usr/bin/env python3
"""
score.py — Scores an agent governance manual against the quality rubric
...
RUBRIC = {
    "Governance Coverage": {"weight": 0.25, "description": "Completeness across interaction protocols, escalation, data handling, error behavior, context sharing, tool access, retirement"},
    "Standards Clarity": {"weight": 0.25, "description": "Specificity and actionability of each standard using imperative voice"},
    "Compliance Adequacy": {"weight": 0.20, "description": "Coverage of security, privacy, and regulatory constraints with testing criteria"},
    "Lifecycle Completeness": {"weight": 0.15, "description": "Provisioning, versioning, deprecation, and retirement procedures"},
    "Stakeholder Alignment": {"weight": 0.15, "description": "Evidence of review and ratification by COO and department leads"},
}
