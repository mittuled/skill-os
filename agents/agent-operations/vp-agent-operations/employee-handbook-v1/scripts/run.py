#!/usr/bin/env python3
"""
run.py — Orchestrates the full employee-handbook-v1 workflow.

Runs the complete employee handbook v1 workflow: score input document and generate output template.
