...
- [`sales-playbook-builder`](../../sales-manager/sales-playbook-builder/SKILL.md) — Defines the messaging framework and objection-handling guidelines that outreach sequences must align with.
- [`sales-signal-collector`](../../account-executive/sales-signal-collector/SKILL.md) — Provides engagement signals and trigger events used for personalization tokens.
