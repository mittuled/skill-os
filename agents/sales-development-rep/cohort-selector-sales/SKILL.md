...
- [`gtm-activation-sales`](../../sales-manager/gtm-activation-sales/SKILL.md) -- Provides the GTM context and pipeline targets the cohort selection serves.
- [`sales-signal-collector`](../../account-executive/sales-signal-collector/SKILL.md) -- Supplies signal data that can inform intent scoring and account prioritization.
