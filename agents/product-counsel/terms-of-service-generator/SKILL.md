...
- [`privacy-policy-generator`](../../product-counsel/privacy-policy-generator/SKILL.md) — Companion document that must be generated alongside or referenced by the ToS for data practice disclosures.
- [`contract-review-orchestrator`](../../corporate-counsel/contract-review-orchestrator/SKILL.md) — Reviews third-party terms that the product may incorporate by reference.
- [`compliance-scanner`](../../corporate-counsel/compliance-scanner/SKILL.md) — Validates regulatory compliance of the generated ToS against applicable frameworks.
