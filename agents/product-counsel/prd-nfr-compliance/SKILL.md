...
- [`compliance-scanner`](../../corporate-counsel/compliance-scanner/SKILL.md) -- The compliance scanner identifies the regulatory frameworks that inform which NFRs must be injected.
