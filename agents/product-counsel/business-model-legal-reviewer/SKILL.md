...
- [`legal-idea-reviewer`](../../general-counsel/legal-idea-reviewer/SKILL.md) -- The idea reviewer provides the initial legal screen; this skill provides deeper analysis once the business model is defined.
