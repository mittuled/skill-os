#!/usr/bin/env python3
"""
generate.py — Generates the output template for training-material-creator-cs

Renders the output template for training-material-creator-cs with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "cs-training-materials-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "training-material-creator-cs"))
    return result
