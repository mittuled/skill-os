#!/usr/bin/env python3
"""
score.py — Scores a training material creator cs output against the quality rubric
...
RUBRIC = {
    "Needs Assessment Quality": {"weight": 0.25, "description": "Data-driven identification of training priorities from performance and releases"},
    "Module Design": {"weight": 0.25, "description": "Structure with learning objectives, content, and practice scenarios"},
    "Content Practicality": {"weight": 0.20, "description": "Customer-value framing rather than feature documentation"},
    "SME Validation": {"weight": 0.15, "description": "Review by product managers and senior CSMs"},
    "Assessment Effectiveness": {"weight": 0.15, "description": "Knowledge checks verifying comprehension and retention"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "training-material-creator-cs",
