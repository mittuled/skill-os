#!/usr/bin/env python3
"""
score.py — Scores a cs onboarding playbook cs output against the quality rubric
...
RUBRIC = {
    "Value Milestone Clarity": {"weight": 0.25, "description": "Specificity and measurability of onboarding success milestones tied to business outcomes"},
    "Journey Completeness": {"weight": 0.25, "description": "End-to-end coverage from contract signing to first value with touchpoints and content"},
    "Segment Adaptability": {"weight": 0.20, "description": "Distinct tracks for enterprise, mid-market, and self-serve segments"},
    "Handoff Quality": {"weight": 0.15, "description": "Clarity of sales-to-CS and onboarding-to-steady-state transitions"},
    "Measurement Framework": {"weight": 0.15, "description": "Time-to-value, completion rate, and drop-off tracking robustness"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "cs-onboarding-playbook-cs",
