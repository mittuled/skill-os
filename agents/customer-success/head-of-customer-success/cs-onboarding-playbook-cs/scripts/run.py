#!/usr/bin/env python3
"""
run.py — Orchestrates the full cs-onboarding-playbook-cs workflow.

Runs the complete cs onboarding playbook cs workflow: score input document and generate output template.
