#!/usr/bin/env python3
"""
generate.py — Generates the output template for cs-onboarding-playbook-cs

Renders the output template for cs-onboarding-playbook-cs with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "onboarding-playbook-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "cs-onboarding-playbook-cs"))
    return result
