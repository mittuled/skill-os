...
- [`cohort-selector-cs`](../../../customer-success/cs-manager/cohort-selector-cs/SKILL.md) -- Cohort selection provides the participant pool for UAT.
- [`cs-release-readiness`](../../../customer-success/cs-manager/cs-release-readiness/SKILL.md) -- UAT results feed into release readiness decisions.
- [`user-feedback-synthesiser-cs`](../../../customer-success/customer-success-manager/user-feedback-synthesiser-cs/SKILL.md) -- UAT feedback contributes to broader feedback synthesis.
