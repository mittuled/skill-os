#!/usr/bin/env python3
"""
run.py — Orchestrates the full uat-coordinator-cs workflow.

Runs the complete uat coordinator cs workflow: score input document and generate output template.
