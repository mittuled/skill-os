#!/usr/bin/env python3
"""
score.py — Scores a UAT results report against the quality rubric
...
RUBRIC = {
    "Scope Definition": {"weight": 0.20, "description": "Clarity of what is tested, acceptance criteria, and test scenarios"},
    "Participant Selection": {"weight": 0.20, "description": "Use case fit, technical readiness, and diversity of participants"},
    "Session Facilitation": {"weight": 0.25, "description": "Balance of scripted and exploratory testing with real-time capture"},
    "Synthesis Quality": {"weight": 0.20, "description": "Issue classification by severity with go/no-go recommendation"},
    "Stakeholder Communication": {"weight": 0.15, "description": "Timely reporting to product, engineering, and CS"},
}
