#!/usr/bin/env python3
"""
generate.py — Generates the output template for uat-coordinator-cs

Renders the output template for uat-coordinator-cs with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "uat-results-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "uat-coordinator-cs"))
    return result
