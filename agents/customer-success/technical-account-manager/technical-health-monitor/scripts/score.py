#!/usr/bin/env python3
"""
score.py — Scores a technical health monitor output against the quality rubric
...
RUBRIC = {
    "Metric Definition": {"weight": 0.20, "description": "Per-account technical metrics: API errors, uptime, latency, sync rates, auth failures"},
    "Monitoring Coverage": {"weight": 0.20, "description": "Instrumentation across all enterprise integrations"},
    "Review Quality": {"weight": 0.25, "description": "Degradation trend identification, capacity concerns, and risk assessment"},
    "Resolution Effectiveness": {"weight": 0.20, "description": "Root cause investigation quality and communication timeliness"},
    "Stakeholder Reporting": {"weight": 0.15, "description": "QBR-ready health summaries with risks and recommendations"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "technical-health-monitor",
