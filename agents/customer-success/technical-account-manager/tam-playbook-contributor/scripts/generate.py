#!/usr/bin/env python3
"""
generate.py — Generates the output template for tam-playbook-contributor

Renders the output template for tam-playbook-contributor with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "tam-playbook-section-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "tam-playbook-contributor"))
    return result
