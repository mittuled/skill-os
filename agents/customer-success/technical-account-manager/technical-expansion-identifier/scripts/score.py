#!/usr/bin/env python3
"""
score.py — Scores a technical expansion identifier output against the quality rubric
...
RUBRIC = {
    "Usage Analysis Depth": {"weight": 0.25, "description": "Data-driven expansion indicator identification from usage patterns"},
    "Needs Mapping Quality": {"weight": 0.25, "description": "Thoroughness of unmet technical needs discovery"},
    "Product Matching Accuracy": {"weight": 0.25, "description": "Correctness of needs-to-product capability mapping"},
    "Qualification Rigour": {"weight": 0.25, "description": "Account readiness, revenue potential, and implementation complexity assessment"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "technical-expansion-identifier",
