#!/usr/bin/env python3
"""
generate.py — Generates the output template for cs-activation

Renders the output template for cs-activation with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "activation-record-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "cs-activation"))
    return result
