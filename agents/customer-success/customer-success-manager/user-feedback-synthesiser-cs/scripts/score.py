#!/usr/bin/env python3
"""
score.py — Scores a user feedback synthesiser cs output against the quality rubric
...
RUBRIC = {
    "Aggregation Completeness": {"weight": 0.25, "description": "Coverage of all feedback sources: signals, NPS, tickets, QBRs, CSM notes"},
    "Theme Identification": {"weight": 0.25, "description": "Rigour of affinity clustering with frequency quantification"},
    "Impact Assessment": {"weight": 0.25, "description": "Business impact estimation per theme: revenue risk, expansion blocked, satisfaction"},
    "Actionability": {"weight": 0.25, "description": "Ranked themes with representative quotes and specific recommended actions"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "user-feedback-synthesiser-cs",
