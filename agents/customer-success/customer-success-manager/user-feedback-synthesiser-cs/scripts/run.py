#!/usr/bin/env python3
"""
run.py — Orchestrates the full user-feedback-synthesiser-cs workflow.

Runs the complete user feedback synthesiser cs workflow: score input document and generate output template.
