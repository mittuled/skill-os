#!/usr/bin/env python3
"""
score.py — Scores a cs signal extractor output against the quality rubric
...
RUBRIC = {
    "Capture Completeness": {"weight": 0.25, "description": "Structured capture with customer, date, context, and tagging"},
    "Classification Accuracy": {"weight": 0.25, "description": "Correct signal type assignment (feedback/request/competitive/churn/expansion)"},
    "Strength Assessment": {"weight": 0.25, "description": "Appropriate reliability rating (anecdote vs pattern, strategic vs edge)"},
    "Routing Effectiveness": {"weight": 0.25, "description": "Timely delivery to appropriate stakeholders with context"},
}
