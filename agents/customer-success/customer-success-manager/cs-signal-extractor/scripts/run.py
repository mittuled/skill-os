#!/usr/bin/env python3
"""
run.py — Orchestrates the full cs-signal-extractor workflow.

Runs the complete cs signal extractor workflow: score input document and generate output template.
