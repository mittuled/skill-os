#!/usr/bin/env python3
"""
run.py — Orchestrates the full early-adopter-success-builder-cs workflow.

Runs the complete early adopter success builder cs workflow: score input document and generate output template.
