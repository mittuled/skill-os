#!/usr/bin/env python3
"""
score.py — Scores a customer advisory board runner output against the quality rubric
...
RUBRIC = {
    "Charter Quality": {"weight": 0.20, "description": "Clear purpose, scope, member commitment, and value proposition"},
    "Member Diversity": {"weight": 0.25, "description": "Mix of sizes, industries, use cases, and constructively critical voices"},
    "Meeting Effectiveness": {"weight": 0.25, "description": "Structured agenda with actionable discussion and insight capture"},
    "Insight Actionability": {"weight": 0.15, "description": "Strategic recommendations routed to relevant teams"},
    "Closed-Loop Follow-Up": {"weight": 0.15, "description": "Evidence that CAB input influenced decisions, communicated back to members"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "customer-advisory-board-runner",
