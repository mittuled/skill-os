#!/usr/bin/env python3
"""
run.py — Orchestrates the full customer-advisory-board-runner workflow.

Runs the complete customer advisory board runner workflow: score input document and generate output template.
