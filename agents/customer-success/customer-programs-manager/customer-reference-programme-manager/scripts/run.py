#!/usr/bin/env python3
"""
run.py — Orchestrates the full customer-reference-programme-manager workflow.

Runs the complete customer reference programme manager workflow: score input document and generate output template.
