#!/usr/bin/env python3
"""
score.py — Scores a customer reference programme manager output against the quality rubric
...
RUBRIC = {
    "Database Completeness": {"weight": 0.20, "description": "Reference profiles with industry, use case, outcomes, and availability"},
    "Segmentation Quality": {"weight": 0.20, "description": "Attributes that matter for prospect matching"},
    "Request Fulfillment": {"weight": 0.25, "description": "Match quality and coordination effectiveness"},
    "Reference Protection": {"weight": 0.20, "description": "Usage tracking and fatigue prevention"},
    "Growth Management": {"weight": 0.15, "description": "Continuous recruitment and profile maintenance"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "customer-reference-programme-manager",
