#!/usr/bin/env python3
"""
run.py — Orchestrates the full nps-programme-manager workflow.

Runs the complete nps programme manager workflow: score input document and generate output template.
