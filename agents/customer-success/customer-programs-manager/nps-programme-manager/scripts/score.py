#!/usr/bin/env python3
"""
score.py — Scores a nps programme manager output against the quality rubric
...
RUBRIC = {
    "Programme Design": {"weight": 0.20, "description": "Timing, frequency, audience selection avoiding survey fatigue"},
    "Analysis Depth": {"weight": 0.25, "description": "Segmented scores, trends, and verbatim theme analysis"},
    "Closed-Loop Quality": {"weight": 0.25, "description": "Detractor follow-up, promoter engagement, passive outreach"},
    "Action-Driving Effectiveness": {"weight": 0.15, "description": "Routing insights to product, CS, leadership with tracking"},
    "Trend Measurement": {"weight": 0.15, "description": "Score tracking across cycles with action-to-improvement correlation"},
}
