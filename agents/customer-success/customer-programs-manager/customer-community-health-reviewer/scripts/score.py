#!/usr/bin/env python3
"""
score.py — Scores a customer community health reviewer output against the quality rubric
...
RUBRIC = {
    "Metric Coverage": {"weight": 0.30, "description": "Active members, post frequency, response rates, new member onboarding, churn"},
    "Health Assessment Quality": {"weight": 0.25, "description": "Threshold-based evaluation with trend identification"},
    "Root Cause Diagnosis": {"weight": 0.25, "description": "Specific identification of declining engagement causes"},
    "Intervention Actionability": {"weight": 0.20, "description": "Specific programme recommendations with expected impact"},
}
