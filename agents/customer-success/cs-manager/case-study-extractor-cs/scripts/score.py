#!/usr/bin/env python3
"""
score.py — Scores a case study extractor cs output against the quality rubric
...
RUBRIC = {
    "Candidate Identification": {"weight": 0.25, "description": "Data-driven selection using health scores, NPS, and outcome metrics"},
    "Permission & Compliance": {"weight": 0.25, "description": "Customer consent secured with legal/contractual verification"},
    "Story Quality": {"weight": 0.25, "description": "Compelling narrative with quantified outcomes and customer context"},
    "Pipeline Management": {"weight": 0.25, "description": "Continuous pipeline vs reactive extraction"},
}
