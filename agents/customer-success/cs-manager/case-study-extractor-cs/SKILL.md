...
- [`customer-reference-programme-manager`](../../../customer-success/customer-programs-manager/customer-reference-programme-manager/SKILL.md) -- Case studies feed into the reference programme.
- [`cs-health-monitor`](../cs-health-monitor/SKILL.md) -- Health data helps identify case study candidates.
- [`cs-signal-extractor`](../../../customer-success/customer-success-manager/cs-signal-extractor/SKILL.md) -- Customer signals may surface case study-worthy outcomes.
