#!/usr/bin/env python3
"""
score.py — Scores a cohort selector cs output against the quality rubric
...
RUBRIC = {
    "Criteria Definition": {"weight": 0.30, "description": "Specificity of selection criteria including health, fit, and readiness"},
    "Screening Methodology": {"weight": 0.25, "description": "Systematic filtering with data-driven ranking"},
    "CSM Validation": {"weight": 0.25, "description": "Contextual validation with assigned CSMs beyond data signals"},
    "Recruitment Quality": {"weight": 0.20, "description": "Clear expectation-setting with confirmed participation"},
}
