#!/usr/bin/env python3
"""
run.py — Orchestrates the full cohort-selector-cs workflow.

Runs the complete cohort selector cs workflow: score input document and generate output template.
