#!/usr/bin/env python3
"""
score.py — Scores a cs release readiness output against the quality rubric
...
RUBRIC = {
    "Release Understanding": {"weight": 0.25, "description": "Completeness of release impact analysis for customer experience"},
    "Preparedness Verification": {"weight": 0.25, "description": "Training, runbook, and CSM briefing completion verification"},
    "Communication Planning": {"weight": 0.25, "description": "Customer-facing communication quality with templates and timeline"},
    "Decision Quality": {"weight": 0.25, "description": "Evidence-based go/no-go recommendation with clear rationale"},
}
