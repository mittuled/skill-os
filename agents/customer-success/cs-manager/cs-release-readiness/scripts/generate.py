#!/usr/bin/env python3
"""
generate.py — Generates the output template for cs-release-readiness

Renders the output template for cs-release-readiness with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "cs-release-readiness-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "cs-release-readiness"))
    return result
