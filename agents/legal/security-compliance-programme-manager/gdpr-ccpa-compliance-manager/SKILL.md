...
- [`compliance-scanner`](../../../legal/corporate-counsel/compliance-scanner/SKILL.md) -- The compliance scanner identifies which privacy regulations apply; this skill implements the compliance programme for GDPR and CCPA specifically.
