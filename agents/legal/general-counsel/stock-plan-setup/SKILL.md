...
- [`founder-equity-issuance`](../../../legal/corporate-counsel/founder-equity-issuance/SKILL.md) -- Founder equity issuance should be coordinated with plan setup to ensure consistent vesting terms and cap table accuracy.
- [`83b-election-coordinator`](../../../legal/corporate-counsel/83b-election-coordinator/SKILL.md) -- 83(b) election coordination is triggered when the plan permits early exercise of unvested options or restricted stock grants.
