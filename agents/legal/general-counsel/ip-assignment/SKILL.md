...
1. **IP Inventory Audit**: Identify all individuals who have contributed or will contribute intellectual property, including founders' pre-incorporation work, employee inventions, and contractor deliverables. Follow the pre-assignment audit section of the checklist at `references/checklist.md`. Deliverable: IP contributor roster with contribution type, date range, and current assignment status.
2. **Prior Art and Pre-existing IP Assessment**: Determine whether contributors hold pre-existing IP that will be incorporated into company products. Check prior employer invention assignment obligations and university IP policies for academic founders. Distinguish between IP that must be assigned outright (17 USC 201 copyright, 35 USC 261 patent) and IP that can be licensed in. Deliverable: pre-existing IP schedule listing each item, its owner, and the proposed treatment (assignment vs. license).
3. **Agreement Drafting**: Draft IP assignment agreements tailored to contributor type per the agreement requirements in `references/checklist.md`. Founder assignments: present-tense assignment ("hereby assigns"), work-for-hire declarations (17 USC 101), moral rights waivers, invention disclosure obligations. Employee agreements: standalone IP assignment with state-specific carve-outs (CA Labor Code 2870, IL 765 ILCS 1060). Contractor agreements: work-for-hire clauses with fallback assignment provisions. Deliverable: executed IP assignment agreements per contributor.
4. **Execution and Filing**: Circulate agreements for signature, track execution status, and file required patent assignment recordations (USPTO per 35 USC 261) or copyright recordations (Copyright Office per 17 USC 205). Deliverable: signed agreement repository with execution log.
5. **Gap Remediation**: Identify gaps in the IP chain of title (unsigned agreements, ambiguous scope, state law limitations on work-for-hire) and remediate through supplemental assignments or confirmatory agreements. Verify due diligence readiness per `references/checklist.md`. Deliverable: gap analysis report with remediation actions completed or escalated.
...
- [`founder-equity-issuance`](../../../legal/corporate-counsel/founder-equity-issuance/SKILL.md) -- Founder IP assignment should be executed concurrently with equity issuance to ensure consideration flows both ways.
- [`legal-template-library-builder`](../../../legal/corporate-counsel/legal-template-library-builder/SKILL.md) -- IP assignment templates feed into the broader template library for reuse across future engagements.
