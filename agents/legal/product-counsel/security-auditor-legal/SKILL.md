...
- [`penetration-test-programme-manager`](../../../legal/security-compliance-programme-manager/penetration-test-programme-manager/SKILL.md) -- Penetration test findings are a primary input to this skill's disclosure analysis.
