#!/usr/bin/env python3
"""
run.py — Orchestrates the full recruiting-pipeline-builder workflow.

Runs the complete recruiting pipeline builder workflow: score input document and generate output template.
