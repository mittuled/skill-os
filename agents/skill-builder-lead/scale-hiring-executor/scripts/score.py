#!/usr/bin/env python3
"""
score.py — Scores a scale skill build execution against the quality rubric
...
RUBRIC = {
    "Scale Planning": {"weight": 0.20, "description": "Accuracy of total skill count, complexity distribution, and timeline"},
    "Builder Allocation": {"weight": 0.20, "description": "Effectiveness of domain-matched assignments with capacity awareness"},
    "Quality Standards": {"weight": 0.20, "description": "Consistency of standards, templates, and review criteria across builders"},
    "Coordination Effectiveness": {"weight": 0.20, "description": "Sync cadence, blocker resolution speed, and work redistribution"},
    "Delivery Completeness": {"weight": 0.20, "description": "Percentage of skills validated and registered vs planned"},
}
