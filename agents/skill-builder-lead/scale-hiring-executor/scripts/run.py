#!/usr/bin/env python3
"""
run.py — Orchestrates the full scale-hiring-executor workflow.

Runs the complete scale hiring executor workflow: score input document and generate output template.
