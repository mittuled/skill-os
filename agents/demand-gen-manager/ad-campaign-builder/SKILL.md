...
- [`funnel-optimizer`](../../demand-gen-manager/funnel-optimizer/SKILL.md) — Campaign performance data feeds funnel analysis; funnel insights inform campaign targeting adjustments.
- [`landing-page-auditor`](../../demand-gen-manager/landing-page-auditor/SKILL.md) — Ad campaigns drive traffic to landing pages; page quality directly impacts campaign ROAS.
- [`campaign-analytics-reporter`](../../marketing-operations-manager/campaign-analytics-reporter/SKILL.md) — Ongoing campaign performance reporting informs budget reallocation and structure changes.
- [`channel-signal-analyst`](../../demand-gen-manager/channel-signal-analyst/SKILL.md) — Channel signals inform platform selection and budget allocation decisions.
