...
- [`content-marketing-operations`](../../content-marketer/content-marketing-operations/SKILL.md) — Operates the day-to-day content production that this engine enables.
...
- [`demand-gen-planner`](../../vp-marketing/demand-gen-planner/SKILL.md) — Sets the campaign themes and lead targets that the content engine must support.
