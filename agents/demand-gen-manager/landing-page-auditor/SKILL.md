...
- [`funnel-optimizer`](../../demand-gen-manager/funnel-optimizer/SKILL.md) — Landing page conversion rate is a primary TOFU-to-MOFU transition metric; audit fixes should be tracked in the funnel optimisation roadmap.
- [`ad-campaign-builder`](../../demand-gen-manager/ad-campaign-builder/SKILL.md) — Ad creative must match landing page messaging; campaign builder should be updated when headline or offer changes are recommended.
- [`campaign-analytics-reporter`](../../marketing-operations-manager/campaign-analytics-reporter/SKILL.md) — Analytics data (bounce rate, scroll depth, conversion rate) provides the evidence base for audit findings.
