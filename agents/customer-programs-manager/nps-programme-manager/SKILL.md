...
- [`user-feedback-synthesiser-cs`](../../customer-success-manager/user-feedback-synthesiser-cs/SKILL.md) -- NPS verbatims are a key input for feedback synthesis.
- [`cs-health-monitor`](../../cs-manager/cs-health-monitor/SKILL.md) -- NPS scores feed into customer health scoring.
