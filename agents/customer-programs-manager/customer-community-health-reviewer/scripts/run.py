#!/usr/bin/env python3
"""
run.py — Orchestrates the full customer-community-health-reviewer workflow.

Runs the complete customer community health reviewer workflow: score input document and generate output template.
