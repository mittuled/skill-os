#!/usr/bin/env python3
"""
generate.py — Generates the output template for customer-advisory-board-runner

Renders the output template for customer-advisory-board-runner with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "cab-insights-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "customer-advisory-board-runner"))
    return result
