#!/usr/bin/env python3
"""
run.py — Orchestrates the full cs-release-readiness workflow.

Runs the complete cs release readiness workflow: score input document and generate output template.
