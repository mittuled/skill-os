#!/usr/bin/env python3
"""
score.py — Scores a cs health monitor output against the quality rubric
...
RUBRIC = {
    "Health Model Design": {"weight": 0.25, "description": "Completeness of health components: usage, sentiment, engagement with weights"},
    "Data Quality": {"weight": 0.20, "description": "Freshness, completeness, and source diversity of health data"},
    "Classification Accuracy": {"weight": 0.25, "description": "Correctness of healthy/at-risk/critical tier assignments"},
    "Trend Analysis Quality": {"weight": 0.15, "description": "Portfolio-level pattern identification with segment analysis"},
    "Intervention Effectiveness": {"weight": 0.15, "description": "Timeliness and appropriateness of triggered actions"},
}
