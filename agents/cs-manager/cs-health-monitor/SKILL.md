...
- [`sla-definer-cs`](../../head-of-customer-success/sla-definer-cs/SKILL.md) -- SLA adherence is a component of health scoring.
- [`expansion-motion-designer-cs`](../../head-of-customer-success/expansion-motion-designer-cs/SKILL.md) -- Healthy accounts with expansion signals feed into the expansion motion.
- [`cs-signal-extractor`](../../customer-success-manager/cs-signal-extractor/SKILL.md) -- Qualitative signals from CSM interactions supplement health score data.
