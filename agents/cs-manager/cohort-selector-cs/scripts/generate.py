#!/usr/bin/env python3
"""
generate.py — Generates the output template for cohort-selector-cs

Renders the output template for cohort-selector-cs with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "cohort-selection-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "cohort-selector-cs"))
    return result
