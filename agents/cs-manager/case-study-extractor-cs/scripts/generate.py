#!/usr/bin/env python3
"""
generate.py — Generates the output template for case-study-extractor-cs

Renders the output template for case-study-extractor-cs with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "case-study-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "case-study-extractor-cs"))
    return result
