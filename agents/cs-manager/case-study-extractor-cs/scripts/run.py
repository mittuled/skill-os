#!/usr/bin/env python3
"""
run.py — Orchestrates the full case-study-extractor-cs workflow.

Runs the complete case study extractor cs workflow: score input document and generate output template.
