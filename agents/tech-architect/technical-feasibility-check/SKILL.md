...
related-skills:
  ...
  - ../../tech-architect/design-feasibility-reviewer/SKILL.md
---
...
- [`architecture-designer`](../../tech-architect/architecture-designer/SKILL.md) -- feasibility checks inform and constrain the architecture design that follows a go decision.
- [`design-feasibility-reviewer`](../../tech-architect/design-feasibility-reviewer/SKILL.md) -- design feasibility reviews complement technical checks by validating UX and interaction assumptions.
