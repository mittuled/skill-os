...
- [`architecture-designer`](../../tech-architect/architecture-designer/SKILL.md) -- the architecture design drives the stack and structure choices that the scaffold implements.
- [`api-contract-definer`](../../tech-architect/api-contract-definer/SKILL.md) -- API contracts determine which endpoints and interfaces the scaffold must stub out.
