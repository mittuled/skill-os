...
complexity: medium
related-skills:
  - ../../tech-architect/performance-budget-setter-eng/SKILL.md
  - ../../tech-architect/scale-infrastructure-planner/SKILL.md
---
...
- [`performance-budget-setter-eng`](../../tech-architect/performance-budget-setter-eng/SKILL.md) -- performance budgets constrain the latency and throughput targets that SLAs codify.
- [`scale-infrastructure-planner`](../../tech-architect/scale-infrastructure-planner/SKILL.md) -- infrastructure scaling plans must align with the availability and throughput targets defined in SLAs.
