...
- [`support-runbook-builder`](../../support-manager/support-runbook-builder/SKILL.md) -- runbooks provide the resolution procedures agents follow after triage routes the ticket.
