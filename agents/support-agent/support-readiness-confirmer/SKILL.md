...
- [`support-activation`](../../support-manager/support-activation/SKILL.md) -- activation builds the support function; readiness confirmation validates it before each release.
