...
- [`help-centre-builder-support`](../../support-manager/help-centre-builder-support/SKILL.md) -- theme analysis identifies which help articles should be created or updated.
