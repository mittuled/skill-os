...
- [`implementation-playbook-builder`](../../implementation-lead/implementation-playbook-builder/SKILL.md) -- the playbook defines the discovery phase that this skill executes.
...
- [`integration-catalogue-builder`](../../implementation-lead/integration-catalogue-builder/SKILL.md) -- the integration catalogue informs which integrations to probe during discovery.
