...
- [`implementation-playbook-builder`](../../implementation-lead/implementation-playbook-builder/SKILL.md) -- the playbook defines the process this skill follows for each customer.
- [`integration-catalogue-builder`](../../implementation-lead/integration-catalogue-builder/SKILL.md) -- the catalogue provides the integration setup guides used during onboarding.
