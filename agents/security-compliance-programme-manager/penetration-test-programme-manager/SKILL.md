...
related-skills:
  ...
  - ../../product-counsel/security-auditor-legal/SKILL.md
---
...
- [`security-auditor-legal`](../../product-counsel/security-auditor-legal/SKILL.md) -- Legal review of pentest findings determines whether disclosure obligations are triggered.
