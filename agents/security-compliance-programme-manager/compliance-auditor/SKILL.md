...
- [`contract-review-orchestrator`](../../corporate-counsel/contract-review-orchestrator/SKILL.md) -- Compliance audit findings inform contract review by identifying which compliance commitments the company can credibly make to counterparties.
