...
- [`saas-stack-manager`](../../../technical-operations/it-operations-manager/saas-stack-manager/SKILL.md) -- SaaS stack manager identifies when a new procurement is needed for software tools.
