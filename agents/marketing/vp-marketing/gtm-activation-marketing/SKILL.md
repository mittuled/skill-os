...
- [`press-release-writer`](../../../marketing/pr-communications-manager/press-release-writer/SKILL.md) — Coordinates the earned media component of launch activation.
- [`content-marketing-operations`](../../../marketing/content-marketer/content-marketing-operations/SKILL.md) — Produces the content assets required for activation.
