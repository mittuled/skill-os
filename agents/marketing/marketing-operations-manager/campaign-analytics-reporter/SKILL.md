...
- [`channel-signal-analyst`](../../../marketing/demand-gen-manager/channel-signal-analyst/SKILL.md) — Consumes this report's data to perform deeper channel-level analysis and reallocation recommendations.
- [`demand-gen-planner`](../../../marketing/vp-marketing/demand-gen-planner/SKILL.md) — Sets the targets that this report measures performance against.
