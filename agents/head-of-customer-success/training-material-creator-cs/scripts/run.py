#!/usr/bin/env python3
"""
run.py — Orchestrates the full training-material-creator-cs workflow.

Runs the complete training material creator cs workflow: score input document and generate output template.
