#!/usr/bin/env python3
"""
run.py — Orchestrates the full expansion-motion-designer-cs workflow.

Runs the complete expansion motion designer cs workflow: score input document and generate output template.
