#!/usr/bin/env python3
"""
score.py — Scores a expansion motion designer cs output against the quality rubric
...
RUBRIC = {
    "Signal Definition Quality": {"weight": 0.25, "description": "Specificity of expansion triggers with quantitative thresholds"},
    "Qualification Framework": {"weight": 0.25, "description": "Rigour of signal-to-opportunity conversion criteria"},
    "Handoff Protocol Quality": {"weight": 0.20, "description": "Completeness of CS-to-AM transition with context preservation"},
    "Playbook Actionability": {"weight": 0.15, "description": "CS team guide with conversation frameworks and timing guidance"},
    "Tracking Completeness": {"weight": 0.15, "description": "Metrics for signal-to-opportunity conversion and CS-sourced revenue"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "expansion-motion-designer-cs",
