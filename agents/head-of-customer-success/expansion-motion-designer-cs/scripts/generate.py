#!/usr/bin/env python3
"""
generate.py — Generates the output template for expansion-motion-designer-cs

Renders the output template for expansion-motion-designer-cs with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "expansion-motion-design-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "expansion-motion-designer-cs"))
    return result
