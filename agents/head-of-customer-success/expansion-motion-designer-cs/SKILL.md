...
- [`cs-health-monitor`](../../cs-manager/cs-health-monitor/SKILL.md) -- Health monitoring provides the signals that trigger the expansion motion.
- [`cs-signal-extractor`](../../customer-success-manager/cs-signal-extractor/SKILL.md) -- Signal extraction identifies expansion indicators from customer interactions.
