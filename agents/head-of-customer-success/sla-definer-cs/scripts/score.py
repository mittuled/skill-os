#!/usr/bin/env python3
"""
score.py — Scores a sla definer cs output against the quality rubric
...
RUBRIC = {
    "Segmentation Quality": {"weight": 0.25, "description": "Appropriateness of tier assignments based on value, complexity, and strategy"},
    "SLA Metric Specificity": {"weight": 0.25, "description": "Measurability of per-tier commitments with realistic targets"},
    "Escalation Matrix Quality": {"weight": 0.20, "description": "Completeness of severity levels with response time requirements"},
    "Documentation Clarity": {"weight": 0.15, "description": "Internal and external SLA documentation quality"},
    "Monitoring Setup": {"weight": 0.15, "description": "Automated tracking and breach alerting configuration"},
}
