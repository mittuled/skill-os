#!/usr/bin/env python3
"""
generate.py — Generates the output template for sla-definer-cs

Renders the output template for sla-definer-cs with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "sla-framework-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "sla-definer-cs"))
    return result
