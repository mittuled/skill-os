#!/usr/bin/env python3
"""
score.py — Scores a support runbook builder cs output against the quality rubric
...
RUBRIC = {
    "Scenario Coverage": {"weight": 0.25, "description": "Completeness of common scenario catalog with frequency data"},
    "Procedure Quality": {"weight": 0.25, "description": "Step-by-step resolution with decision points and communication templates"},
    "Escalation Clarity": {"weight": 0.20, "description": "Defined triggers, targets, and required context for escalation"},
    "Team Validation": {"weight": 0.15, "description": "Evidence of peer review incorporating real-world edge cases"},
    "Maintenance Process": {"weight": 0.15, "description": "Update cadence and trigger for runbook revisions"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "support-runbook-builder-cs",
