#!/usr/bin/env python3
"""
run.py — Orchestrates the full support-runbook-builder-cs workflow.

Runs the complete support runbook builder cs workflow: score input document and generate output template.
