#!/usr/bin/env python3
"""
generate.py — Generates the output template for support-runbook-builder-cs

Renders the output template for support-runbook-builder-cs with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "cs-runbook-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "support-runbook-builder-cs"))
    return result
