...
- [`ticket-theme-analyst`](../../../customer-support/support-agent/ticket-theme-analyst/SKILL.md) -- ticket theme analysis identifies which help articles to prioritise.
- [`help-content-reviewer`](../../../customer-support/support-agent/help-content-reviewer/SKILL.md) -- reviews help centre content for accuracy after product changes.
