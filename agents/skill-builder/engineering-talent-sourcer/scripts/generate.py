#!/usr/bin/env python3
"""
generate.py — Generates the output template for engineering-talent-sourcer

Renders the output template for engineering-talent-sourcer with provided or placeholder data.
...
TEMPLATE_PATH = Path(__file__).parent.parent / "assets" / "skill-build-report-template.md"
...
def render_template(template: str, data: dict) -> str:
    ...
    result = result.replace("[skill-slug that produced this]", data.get("skill", "engineering-talent-sourcer"))
    return result
