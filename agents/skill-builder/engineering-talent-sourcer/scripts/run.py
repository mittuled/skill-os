#!/usr/bin/env python3
"""
run.py — Orchestrates the full engineering-talent-sourcer workflow.

Runs the complete engineering talent sourcer workflow: score input document and generate output template.
