#!/usr/bin/env python3
"""
score.py — Scores an individual skill build against the quality rubric
...
RUBRIC = {
    "Specification Adherence": {"weight": 0.25, "description": "Alignment of skill output with original specification and acceptance criteria"},
    "Workflow Specificity": {"weight": 0.25, "description": "Presence of named frameworks, defined deliverables, and decision criteria per step"},
    "Anti-Pattern Quality": {"weight": 0.20, "description": "Actionability of anti-patterns with domain-specific rationale"},
    "Cross-Reference Accuracy": {"weight": 0.15, "description": "Bidirectional references that are valid and include rationale"},
    "Validation Compliance": {"weight": 0.15, "description": "Passing validation script with 0 errors and word limit compliance"},
}
...
def score_document(text: str) -> dict:
    ...
    return {
        "skill": "engineering-talent-sourcer",
