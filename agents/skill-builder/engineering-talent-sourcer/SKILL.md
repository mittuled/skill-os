...
- [`recruiting-pipeline-builder`](../../skill-builder-lead/recruiting-pipeline-builder/SKILL.md) -- Provides the skill specifications and assignments this skill executes.
- [`scale-hiring-executor`](../../skill-builder-lead/scale-hiring-executor/SKILL.md) -- Coordinates parallel execution when multiple skills are being built.
- [`skills-gap-analyser`](../../agent-trainer-skill-optimizer/skills-gap-analyser/SKILL.md) -- Identifies skill deficiencies that may require new skills to be built.
