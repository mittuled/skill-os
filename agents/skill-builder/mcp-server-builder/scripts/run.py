#!/usr/bin/env python3
"""
run.py — Orchestrates the full mcp-server-builder workflow.

Runs the complete mcp server builder workflow: score input document and generate output template.
