#!/usr/bin/env python3
"""Score a backlog-groomer exercise against the scoring rubric.

Usage:
    echo '{"acceptance_criteria_quality": 8, "estimation_accuracy": 8, "rice_prioritisation": 8, "backlog_hygiene": 8}' | python3 score.py
"""
...
CRITERIA: dict[str, float] = {
    ...
    "rice_prioritisation": 0.25,
    "backlog_hygiene": 0.25,
}

GRADE_BANDS: list[tuple[str, float, float, str, str]] = [
    ("A+", 9.0, 10.0, "Exceptional", "Backlog is sprint-ready — proceed to sprint planning"),
    ("A", 8.0, 8.9, "Strong", "Minor refinements then proceed to sprint planning"),
    ("B", 7.0, 7.9, "Good", "Address flagged stories before sprint planning"),
    ("C", 5.0, 6.9, "Adequate", "Schedule additional grooming session"),
    ("D", 3.0, 4.9, "Weak", "Restart grooming with engineering present"),
    ("F", 0.0, 2.9, "Failing", "No meaningful grooming performed"),
]
