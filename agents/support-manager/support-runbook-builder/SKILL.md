...
- [`support-ticket-triage`](../../support-agent/support-ticket-triage/SKILL.md) -- triage routes tickets to the correct queue; runbooks tell agents what to do once they receive them.
