...
related-skills:
  ...
  - ../../corporate-counsel/negotiation-strategist/SKILL.md
...
- [`contract-review-orchestrator`](../../corporate-counsel/contract-review-orchestrator/SKILL.md) — Upstream orchestrator that dispatches this skill as part of comprehensive contract review.
- [`contract-risk-analyst`](../../corporate-counsel/contract-risk-analyst/SKILL.md) — Complements gap analysis with quantitative risk assessment of identified exposures.
- [`negotiation-strategist`](../../corporate-counsel/negotiation-strategist/SKILL.md) — Downstream consumer that uses identified gaps as must-have negotiation items.
- [`compliance-scanner`](../../corporate-counsel/compliance-scanner/SKILL.md) — Assesses regulatory compliance, which may surface additional required protections.
