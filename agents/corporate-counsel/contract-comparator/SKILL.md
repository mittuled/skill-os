...
- [`negotiation-strategist`](../../general-counsel/negotiation-strategist/SKILL.md) — Consumes the key deviations and negotiation priorities to develop counterproposals.
- [`missing-protections-finder`](../../general-counsel/missing-protections-finder/SKILL.md) — Identifies protections present in standard terms but absent from the counterparty version.
