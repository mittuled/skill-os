...
- [`contract-review-orchestrator`](../../corporate-counsel/contract-review-orchestrator/SKILL.md) — Reviews counterparty-provided NDAs when company paper is not used.
- [`missing-protections-finder`](../../corporate-counsel/missing-protections-finder/SKILL.md) — Validates generated NDA against the NDA protection checklist.
- [`terms-of-service-generator`](../../product-counsel/terms-of-service-generator/SKILL.md) — Parallel document generation skill for product-facing legal documents.
