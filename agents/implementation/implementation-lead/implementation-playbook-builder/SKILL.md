...
- [`implementation-requirements-extractor`](../../../implementation/implementation-engineer/implementation-requirements-extractor/SKILL.md) -- requirements extraction is the first phase the playbook defines.
- [`technical-onboarding-runner`](../../../implementation/implementation-engineer/technical-onboarding-runner/SKILL.md) -- onboarding runners execute the playbook with each customer.
