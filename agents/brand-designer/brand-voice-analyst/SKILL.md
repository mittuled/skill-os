...
complexity: medium
related-skills:
  - ../../brand-designer/brand-foundation/SKILL.md
  - ../../brand-designer/positioning-crafter-brand/SKILL.md
...
- [`brand-foundation`](../../brand-designer/brand-foundation/SKILL.md) — Brand voice standards originate from the brand foundation; voice analysis requires a documented standard to score against.
- [`positioning-crafter-brand`](../../brand-designer/positioning-crafter-brand/SKILL.md) — Brand positioning drives tone and vocabulary choices; positioning changes should trigger a voice audit of existing content.
- [`landing-page-auditor`](../../demand-gen-manager/landing-page-auditor/SKILL.md) — Landing pages must pass both brand voice and conversion quality checks; findings from both audits may affect the same page.
