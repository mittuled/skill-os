...
- [`channel-signal-analyst`](../../demand-gen-manager/channel-signal-analyst/SKILL.md) — Uses attribution output to recommend budget reallocation across channels.
...
- [`gtm-planner-marketing`](../../vp-marketing/gtm-planner-marketing/SKILL.md) — Uses attribution data to project channel ROI when building GTM plans.
