...
- [`access-provisioning-manager`](../../it-operations-manager/access-provisioning-manager/SKILL.md) -- helpdesk escalates access provisioning needs to the access provisioning manager.
- [`hardware-lifecycle-manager`](../../it-operations-manager/hardware-lifecycle-manager/SKILL.md) -- hardware issues that indicate device failure are escalated for lifecycle action.
