...
complexity: medium
related-skills:
  - ../../tech-lead-pr-reviewer/dependency-mapper/SKILL.md
...
- [`dependency-mapper`](../../tech-lead-pr-reviewer/dependency-mapper/SKILL.md) -- dependency mapping identifies the blockers that this skill resolves.
- [`phase-scope-adjuster-eng`](../../tech-lead-pr-reviewer/phase-scope-adjuster-eng/SKILL.md) -- when a dependency cannot be resolved, scope adjustment may be needed to keep the phase on track.
