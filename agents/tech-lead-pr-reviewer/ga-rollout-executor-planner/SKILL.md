...
related-skills:
  ...
  - ../../devops-infrastructure-engineer/rollout-configurator/SKILL.md
---
...
- [`go-live-approver-eng`](../../tech-lead-pr-reviewer/go-live-approver-eng/SKILL.md) -- go-live approval is the gate that the GA rollout plan must clear before execution begins.
- [`rollout-configurator`](../../devops-infrastructure-engineer/rollout-configurator/SKILL.md) -- the rollout configurator implements the deployment mechanics that the GA plan defines.
