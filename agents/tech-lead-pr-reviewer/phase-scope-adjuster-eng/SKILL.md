...
- [`inter-phase-reviewer-eng`](../../tech-lead-pr-reviewer/inter-phase-reviewer-eng/SKILL.md) -- phase reviews may trigger scope adjustments when deliverables fall short of exit criteria.
- [`dependency-resolver`](../../tech-lead-pr-reviewer/dependency-resolver/SKILL.md) -- unresolved dependencies are a common trigger for mid-phase scope adjustment.
