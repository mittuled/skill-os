...
- [`spec-translator-eng`](../../tech-lead-pr-reviewer/spec-translator-eng/SKILL.md) -- spec translation produces the raw tasks that grooming then refines.
- [`sprint-reviewer-eng`](../../tech-lead-pr-reviewer/sprint-reviewer-eng/SKILL.md) -- sprint reviews surface incomplete work that feeds back into backlog grooming.
