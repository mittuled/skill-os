...
complexity: medium
related-skills:
  - ../../tech-lead-pr-reviewer/dependency-resolver/SKILL.md
  - ../../tech-lead-pr-reviewer/spec-translator-eng/SKILL.md
---
...
- [`dependency-resolver`](../../tech-lead-pr-reviewer/dependency-resolver/SKILL.md) -- once dependencies are mapped, the resolver unblocks tasks when blockers arise.
- [`spec-translator-eng`](../../tech-lead-pr-reviewer/spec-translator-eng/SKILL.md) -- spec translation produces the task breakdown that dependency mapping operates on.
