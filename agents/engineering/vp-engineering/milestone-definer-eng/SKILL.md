...
- [`phase-planner-eng`](../../../engineering/vp-engineering/phase-planner-eng/SKILL.md) -- milestones are derived from and feed back into phase plans.
- [`velocity-monitor`](../../../engineering/vp-engineering/velocity-monitor/SKILL.md) -- milestone progress is tracked via velocity monitoring.
