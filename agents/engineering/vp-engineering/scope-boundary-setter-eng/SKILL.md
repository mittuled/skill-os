...
- [`spec-intake-review`](../../../engineering/vp-engineering/spec-intake-review/SKILL.md) -- spec review establishes the initial scope that this skill protects.
- [`phase-scope-adjuster-eng`](../../../engineering/tech-lead-pr-reviewer/phase-scope-adjuster-eng/SKILL.md) -- handles mid-phase scope adjustments within the boundaries set here.
