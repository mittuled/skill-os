...
- [`sprint-reviewer-eng`](../../../engineering/tech-lead-pr-reviewer/sprint-reviewer-eng/SKILL.md) -- sprint reviews assess completed work formally; demos present it to a broader audience.
- [`go-live-approver-eng`](../../../engineering/tech-lead-pr-reviewer/go-live-approver-eng/SKILL.md) -- demos generate stakeholder confidence that feeds into go-live approval decisions.
