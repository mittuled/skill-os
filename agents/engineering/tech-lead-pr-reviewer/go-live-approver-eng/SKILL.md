...
- [`ga-rollout-executor-planner`](../../../engineering/tech-lead-pr-reviewer/ga-rollout-executor-planner/SKILL.md) -- the GA rollout plan is executed only after go-live approval is granted.
- [`sprint-reviewer-eng`](../../../engineering/tech-lead-pr-reviewer/sprint-reviewer-eng/SKILL.md) -- sprint reviews provide the evidence of completed work that go-live approval evaluates.
