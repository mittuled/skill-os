...
- [`phase-scope-adjuster-eng`](../../../engineering/tech-lead-pr-reviewer/phase-scope-adjuster-eng/SKILL.md) -- phase reviews may reveal the need for scope adjustment in the upcoming phase.
- [`go-live-approver-eng`](../../../engineering/tech-lead-pr-reviewer/go-live-approver-eng/SKILL.md) -- the final phase gate before production is the go-live approval.
