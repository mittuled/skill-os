...
- [`backlog-groomer-eng`](../../../engineering/tech-lead-pr-reviewer/backlog-groomer-eng/SKILL.md) -- sprint review carryover items feed back into backlog grooming for the next sprint.
- [`go-live-approver-eng`](../../../engineering/tech-lead-pr-reviewer/go-live-approver-eng/SKILL.md) -- sprint review completion evidence supports go-live approval decisions.
