...
description: Designs the deployment topology that determines how code reaches users reliably and efficiently. Use when asked to deployment architecture designer. Suggest when relevant.
