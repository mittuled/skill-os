...
- [`builder`](../../../engineering/sr-backend-developer/builder/SKILL.md) -- implements the backend services that consume the data model.
- [`instrumentation-planner-eng`](../../../engineering/sr-backend-developer/instrumentation-planner-eng/SKILL.md) -- plans observability for database query performance and connection pool health.
