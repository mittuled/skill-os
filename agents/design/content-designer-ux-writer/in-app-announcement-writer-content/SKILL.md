...
- [`content-design-spec`](../../../design/content-design-lead/content-design-spec/SKILL.md) — All announcement copy must follow the content design spec voice and tone.
- [`launch-narrative-brand`](../../../design/brand-designer/launch-narrative-brand/SKILL.md) — In-app announcements for major launches should align with the broader launch narrative.
