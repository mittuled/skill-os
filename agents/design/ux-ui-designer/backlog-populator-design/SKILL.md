...
- [`spec-translator-design`](../../../design/head-of-design/spec-translator-design/SKILL.md) -- Design briefs from spec translation are the primary input for backlog population.
- [`effort-estimator-design`](../../../design/head-of-design/effort-estimator-design/SKILL.md) -- Backlog items are the unit of work that effort estimation operates on.
