...
- [`spec-translator-design`](../../../design/head-of-design/spec-translator-design/SKILL.md) -- Translated design briefs define the feature scope that user flows operationalize.
