...
- [`accessibility-checker-design`](../../../design/head-of-design/accessibility-checker-design/SKILL.md) -- Cross-platform testing must include accessibility verification per platform.
