...
- [`sales-signal-synthesizer-am`](../../../account-management/account-management-lead/sales-signal-synthesizer-am/SKILL.md) -- the synthesiser aggregates the signals this skill collects into portfolio insights.
