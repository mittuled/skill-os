...
- [`sales-signal-collector-am`](../../../account-management/account-manager/sales-signal-collector-am/SKILL.md) -- signal collection provides the raw data that this skill synthesises.
