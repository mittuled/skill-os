...
- [`instrumentation-clarity-reviewer`](../../analytics-lead/instrumentation-clarity-reviewer/SKILL.md) -- the analytics lead's clarity review covers spec quality; this skill covers implementation completeness.
