...
- [`instrumentation-spec-data`](../../analytics-lead/instrumentation-spec-data/SKILL.md) -- the product instrumentation spec that growth events extend rather than duplicate.
...
- [`instrumentation-clarity-reviewer`](../../analytics-lead/instrumentation-clarity-reviewer/SKILL.md) -- reviews this spec for completeness and measurability.
- [`growth-model-designer`](../../growth-lead/growth-model-designer/SKILL.md) -- the growth model's metrics drive the measurement requirements this spec fulfils.
