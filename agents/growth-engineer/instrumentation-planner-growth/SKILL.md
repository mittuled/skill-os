...
- [`instrumentation-planner-data`](../../analytics-lead/instrumentation-planner-data/SKILL.md) -- the analytics lead's planner covers product instrumentation; this skill focuses on growth-specific tracking.
