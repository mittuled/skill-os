...
complexity: medium
related-skills:
  - ../../vp-sales/company-researcher/SKILL.md
  - ../../vp-sales/decision-maker-mapper/SKILL.md
  - ../../sales-manager/sales-competitive-intel/SKILL.md
...
- [`company-researcher`](../../vp-sales/company-researcher/SKILL.md) — Provides firmographic and company intelligence that feeds the company snapshot and recent news sections.
- [`decision-maker-mapper`](../../vp-sales/decision-maker-mapper/SKILL.md) — Maps organizational decision-makers that feed the attendee profiles section.
- [`sales-competitive-intel`](../../sales-manager/sales-competitive-intel/SKILL.md) — Provides battle cards and competitive positioning for the competitive landscape section.
