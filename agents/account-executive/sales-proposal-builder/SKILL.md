...
- [`sales-competitive-intel`](../../sales-manager/sales-competitive-intel/SKILL.md) — Provides battle cards and competitive positioning for the differentiation section.
- [`company-researcher`](../../vp-sales/company-researcher/SKILL.md) — Provides firmographic and company intelligence for the current situation section.
