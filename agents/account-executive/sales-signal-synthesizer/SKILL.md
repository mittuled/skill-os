...
- [`objection-handler-updater-sales`](../../sales-manager/objection-handler-updater-sales/SKILL.md) -- Consumes objection themes to update response frameworks.
- [`technical-buyer-signal-extractor`](../../solutions-engineering-manager/technical-buyer-signal-extractor/SKILL.md) -- Provides technical buyer signals that complement sales signal synthesis.
