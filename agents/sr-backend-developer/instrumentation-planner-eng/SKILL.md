...
related-skills:
  ...
  - ../builder/SKILL.md
  - ../../database-expert/data-model-designer/SKILL.md
---
...
- [`data-model-designer`](../../database-expert/data-model-designer/SKILL.md) -- designs data models whose query performance may need observability coverage.
