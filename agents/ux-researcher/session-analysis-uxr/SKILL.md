...
- [`prototype-usability-validator`](../../ux-research-lead/prototype-usability-validator/SKILL.md) — Usability test sessions are a primary input for session analysis.
