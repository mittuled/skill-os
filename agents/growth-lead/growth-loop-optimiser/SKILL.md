...
- [`growth-loop-activator`](../../growth-engineer/growth-loop-activator/SKILL.md) -- implements the loop mechanics that this skill optimizes.
...
- [`funnel-analyser-growth`](../../growth-engineer/funnel-analyser-growth/SKILL.md) -- funnel analysis within each loop node reveals specific conversion bottlenecks.
