...
- [`session-analysis`](../../visual-interaction-designer/session-analysis/SKILL.md) -- Session recordings reveal real-user accessibility friction that scopes audit focus areas.
