...
- [`backlog-populator-design`](../../ux-ui-designer/backlog-populator-design/SKILL.md) -- Translated briefs feed the design backlog as actionable tasks.
- [`flow-designer`](../../ux-ui-designer/flow-designer/SKILL.md) -- Interaction requirements in the brief scope the flow design work.
