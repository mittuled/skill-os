...
- [`component-mapper-design`](../../ux-ui-designer/component-mapper-design/SKILL.md) -- Component mapping must account for accessibility attributes baked into design system components.
