...
- [`instrumentation-spec-data`](../../analytics-lead/instrumentation-spec-data/SKILL.md) -- the spec that this skill implements.
- [`instrumentation-planner-data`](../../analytics-lead/instrumentation-planner-data/SKILL.md) -- the plan that assigns implementation tasks and sequences.
