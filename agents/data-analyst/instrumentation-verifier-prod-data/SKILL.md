...
- [`alerting-configurator-data`](../../analytics-lead/alerting-configurator-data/SKILL.md) -- production event volume alerts are a first line of defence that this skill supplements with manual verification.
