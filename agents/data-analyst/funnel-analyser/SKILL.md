...
- [`funnel-analyser-growth`](../../growth-engineer/funnel-analyser-growth/SKILL.md) -- the growth engineer's funnel analyser focuses on acquisition and activation; this skill covers the full product funnel.
- [`statistical-significance-tracker`](../../analytics-lead/statistical-significance-tracker/SKILL.md) -- experiments targeting funnel steps need significance tracking to validate results.
