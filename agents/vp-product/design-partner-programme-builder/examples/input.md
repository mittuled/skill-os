# Example Input: design-partner-programme-builder

## Context

**Product**: TaskFlow — automated invoice reconciliation tool for mid-market operations teams.

**Situation**: The team is executing the design partner programme builder workflow for TaskFlow's upcoming release.
