...
- [`prospect-analyst-orchestrator`](../../vp-sales/prospect-analyst-orchestrator/SKILL.md) — Orchestrates prospect research that feeds firmographic and technographic data into ICP scoring.
- [`company-researcher`](../../vp-sales/company-researcher/SKILL.md) — Provides company intelligence for firmographic and technographic dimension scoring.
