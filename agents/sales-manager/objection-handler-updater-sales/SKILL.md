...
related-skills:
  ...
  - ../../vp-sales/pricing-finaliser-sales/SKILL.md
...
- [`pricing-finaliser-sales`](../../vp-sales/pricing-finaliser-sales/SKILL.md) -- Surfaces pricing objection data that feeds into handler updates.
- [`sales-signal-synthesizer`](../../account-executive/sales-signal-synthesizer/SKILL.md) -- Provides synthesized signal data on objection patterns from the field.
