# Tasks — Phase 5: Operations + Customer Lifecycle (82 skills, 24 agents)

**Input**: Design documents from `/specs/001-enrich-skill-directory/`
**Prerequisites**: Phase 0 + Phase 1 complete (Phase 2-4 recommended but not blocking)

**Goal**: Enrich the remaining 8 departments that run the day-to-day machine.

**Commit discipline**: Every skill = 1 commit. Format: `Enrich skill: <skill-slug> for <Agent Role>`

---

## Phase 5.0: Research & Ethos

- [ ] T445 Research operations + customer lifecycle best practices — AI agent management, prompt engineering, skill evaluation, multi-agent orchestration, customer health scoring (Gainsight patterns), QBR frameworks, onboarding, churn prediction, support ops (Zendesk/Intercom), ticket triage, ITIL, vendor management, procurement, CRM admin (Salesforce/HubSpot), revenue data governance, lead routing, research-to-product translation, account planning, implementation methodologies, data migration.
- [ ] T446 [P] Write `departments/agent-operations/ideal-agent-operations.md` — ethos profile (max 500 words). 1 commit.
- [ ] T447 [P] Write `departments/customer-success/ideal-customer-success.md` — ethos profile (max 500 words). 1 commit.
- [ ] T448 [P] Write `departments/customer-support/ideal-customer-support.md` — ethos profile (max 500 words). 1 commit.
- [ ] T449 [P] Write `departments/technical-operations/ideal-technical-operations.md` — ethos profile (max 500 words). 1 commit.
- [ ] T450 [P] Write `departments/revenue-operations/ideal-revenue-operations.md` — ethos profile (max 500 words). 1 commit.
- [ ] T451 [P] Write `departments/applied-research/ideal-applied-research.md` — ethos profile (max 500 words). 1 commit.
- [ ] T452 [P] Write `departments/account-management/ideal-account-management.md` — ethos profile (max 500 words). 1 commit.
- [ ] T453 [P] Write `departments/implementation/ideal-implementation.md` — ethos profile (max 500 words). 1 commit.
...
- [ ] T516 [P] Enrich `crm-administrator` — `agents/revenue-operations-manager/crm-administrator/SKILL.md` (complex). 1 commit.
- [ ] T517 [P] Enrich `revenue-data-steward` — `agents/revenue-operations-manager/revenue-data-steward/SKILL.md` (medium). 1 commit.
- [ ] T518 [P] Enrich `sales-process-optimiser` — `agents/revenue-operations-manager/sales-process-optimiser/SKILL.md` (complex). 1 commit.
- [ ] T519 [P] Enrich `commission-plan-modeller` — `agents/revenue-operations-manager/commission-plan-modeller/SKILL.md` (complex). 1 commit.
- [ ] T520 [P] Enrich `reporting-stack-owner` — `agents/revenue-operations-manager/reporting-stack-owner/SKILL.md` (medium). 1 commit.
- [ ] T521 [P] Enrich `lead-routing-engine-manager` — `agents/revenue-operations-manager/lead-routing-engine-manager/SKILL.md` (medium). 1 commit.
...
## Phase 6: Polish & Cross-Cutting (final)

- [ ] T540 Full repo validation: `python scripts/validate.py` — confirm 100% pass rate (SC-002)
- [ ] T541 Cross-reference audit: verify all `related-skills` paths resolve bidirectionally across all departments
- [ ] T542 Document 5+ end-to-end workflows spanning 3+ agents in `_shared/references/workflows/` (SC-005). Examples: new-feature-launch, customer-onboarding, security-incident, hiring, fundraising. 1 commit per workflow.
- [ ] T543 Generate skill index from frontmatter metadata — write to `skill-index.json` at repo root (FR-017). 1 commit.
- [ ] T544 Write `README.md` — comprehensive repo documentation: structure, how to use skills, how to contribute, department overview. 1 commit.
- [ ] T545 Create eval prompts for 10 enriched skills across 5+ departments — store in each skill's `evals/` directory (SC-008). 1 commit per eval.
- [ ] T546 Final `status.md` update — mark all departments and project-level artifacts complete. 1 commit.
...
|---------|-------|--------|
| Research & Ethos | 9 | — |
| Agent Operations (6 agents) | 23 | 23 |
| Customer Success (6 agents) | 21 | 21 |
| Customer Support (2 agents) | 9 | 9 |
| Technical Operations (3 agents) | 9 | 9 |
| Revenue Operations (1 agent) | 6 | 6 |
| Applied Research (1 agent) | 5 | 5 |
| Account Management (2 agents) | 5 | 5 |
| Implementation (2 agents) | 4 | 4 |
| Validate & Finalize | 4 | — |
| Polish (Phase 6) | 7 | — |
| **Total** | **102** | **82** |
